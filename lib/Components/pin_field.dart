...
class PinPut extends StatefulWidget {
  ...
  ///  [submittedFieldDecoration] [selectedFieldDecoration]
  ///  [followingFieldDecoration] [disabledDecoration]
  ...
  ///
  /// can be configured to show an icon, 
  /// border,counter, label, hint text, and error text.
