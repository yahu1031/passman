...
import 'package:passman/platform/mobile/components/get_capacity.dart';
import 'package:passman/platform/mobile/services/support_services.dart';
...
class DecodeRequest {
  ...
  bool shouldDecrypt() => (token != null && token != '');
}

class DecodeResultData {
  DecodeResultData(this.points, this.request);
  final String points;
  final DecodeRequest request;
}
